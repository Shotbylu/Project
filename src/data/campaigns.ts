...
export const campaigns: Campaign[] = [
  {
    ...
    summary:
      'Video-led storytelling to translate Mazda’s brand meaning into measurable engagement and qualified demand.',
    responsibilities: [
      'Creative direction for 9:16 narrative',
      'Sequenced placements across funnel',
      'Daily optimisation and insights',
