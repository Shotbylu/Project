...
const Campaigns: React.FC = () => {
  ...
  // Rename to avoid collision with any existing 'handleOpen'
          ...
          {shouldShowEmptyState ? (
            ...
            <>
              {featuredCampaign && (
                ...
                >
                  <CampaignCard campaign={featuredCampaign} onOpen={openCampaignModal} featured />
                </motion.div>
              )}
